...
"[project]/app/api/auth/validate/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        console.log("[v0] Validating email and phone:", {
            email,
            phone
        });
        ...
        if (email) {
            const existingEmailUsers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT id FROM users WHERE email = ?", [
                email
            ]);
        ...
        if (phone) {
            const existingPhoneUsers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT id FROM users WHERE phone = ?", [
                phone
            ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cab4c6ad._.js.map