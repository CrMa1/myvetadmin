...
const clinicConfig = {
    ...
    tagline: "Cuidado profesional para tus mascotas",
...
"[project]/app/api/consultations/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["initializeDatabase"])();
async function GET() {
    await new Promise((resolve)=>setTimeout(resolve, 300));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].consultations);
}
async function POST(request) {
    await new Promise((resolve)=>setTimeout(resolve, 300));
    const data = await request.json();
    const newConsultation = {
        id: `CONS-${6000 + __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].consultations.length}`,
        ...data,
        date: data.date || new Date().toISOString()
    };
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].consultations.unshift(newConsultation);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newConsultation);
}
async function PUT(request) {
    await new Promise((resolve)=>setTimeout(resolve, 300));
    const data = await request.json();
    const index = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].consultations.findIndex((c)=>c.id === data.id);
    if (index !== -1) {
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].consultations[index] = {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].consultations[index],
            ...data
        };
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].consultations[index]);
    }
...
async function DELETE(request) {
    ...
    const index = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].consultations.findIndex((c)=>c.id === id);
    if (index !== -1) {
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].consultations.splice(index, 1);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f2fb2f31._.js.map