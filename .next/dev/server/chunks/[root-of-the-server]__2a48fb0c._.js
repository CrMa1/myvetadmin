...
async function POST(request) {
    try {
       ...
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [
        ...
        const newItem = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
        i.*,
        i.category_id as categoryId,
        ic.name as category,
        i.expiry_date as expiryDate
...
async function PUT(request) {
    try {
       ...
       WHERE id = ? AND user_id = ? AND clinic_id = ?`, [
        ...
        const updatedItem = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
        i.*,
        i.category_id as categoryId,
        ic.name as category,
        i.expiry_date as expiryDate
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2a48fb0c._.js.map