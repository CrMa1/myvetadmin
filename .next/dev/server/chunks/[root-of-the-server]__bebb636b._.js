...
async function GET() {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].sales
        });
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
...
async function POST(request) {
    try {
        ...
        const newSale = {
            ...
            customer: body.customer || "Cliente general",
            notes: body.notes || ""
        };
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].sales.push(newSale);
        // Update inventory stock
        body.items.forEach((item)=>{
            const inventoryItem = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].inventory.find((i)=>i.id === item.id);
            if (inventoryItem) {
                inventoryItem.stock -= item.quantity;
            }
        });
        // Add to accounting as income
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].accounting.push({
            id: `ACC-${Date.now()}`,
            type: "Ingreso",
            category: "Venta",
            amount: body.total,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bebb636b._.js.map